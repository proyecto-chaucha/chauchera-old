...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Chaucha " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"chauchatools.com", "dnsseed.chauchatools.com"},
    {"chauchapool.org", "dnsseed.chauchapool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"chauchatools.com", "testnet-seed.chauchatools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Chaucha is probably already running."), addrBind.ToString().c_str());
        else
